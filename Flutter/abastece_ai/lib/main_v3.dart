...
class _MyHomePageState extends State<MyHomePage> {
  // FORMA DE NÃO DEIXAR O TECLADO SUMIR
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: TextField(
                          onChanged: (value) {
                            if (value != null) {
                              ColorController().cor = Colors.yellow;
                            } else {
                              ColorController().cor = Colors.grey.shade300;
                            }
                          },
                          onEditingComplete: () {},
                          focusNode: inputFieldNode,
                          onSubmitted: (String) => FocusScope.of(
                                  context) // ESSA PARTE FAZ O TECLADO FICAR SEMPRE ATIVO
                        ...
                        child: ConstrainedBox(
                            ...
                            child: IconButton(
                                onPressed: () {
                                  ...
                                  double valor = lowPrice.numberValue;
                                  double novovalor = 0;
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.bold,
                    decorationColor: ColorController()
                        .cor), //Colors.grey.shade300 ColorController().cor
                textAlign: TextAlign.center,
              ),
            ),
...
class ColorController extends MyHomePage {
  Color cor;
  /*
  @override
  // TODO: implement lowPrice
  MoneyMaskedTextController get lowPrice => super.lowPrice;
  void main(List<String> args) {
    if (lowPrice.numberValue == 0) {
