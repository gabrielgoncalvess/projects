# -*- coding: utf-8 -*-
"""
Created on Mon Feb 15 21:42:49 2021
...
delete_box.grid(row=9, column=1, pady=(20,5))
...
delete_box_label.grid(row=9, column=0, pady=(20,5))
